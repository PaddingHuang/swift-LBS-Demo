...
- (id)initWithAnnotation:(id<MAAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        self.image = [UIImage imageNamed:@"camera_gray"];
...
- (void)setCount:(NSUInteger)count
{
    ...
    if (_count == 1 ){
        ...
        self.image = [UIImage imageNamed:@"camera_blue"];
    }else  if (_count >= 5 && _count <10){
        self.image = [UIImage imageNamed:@"camera_yellow"];
    }else  if (_count >= 10 ){
        self.image = [UIImage imageNamed:@"camera_red"];
    }
//    
//    /* 按count数目设置view的大小. */
